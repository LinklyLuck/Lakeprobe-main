...
DISCOVERY_TESTS = [
    ...
    {"id":"D02","cat":"wine","query":"Find wine data with residual sugar and acidity",
    ...
    # Housing (3)
    {"id":"D04","cat":"housing","query":"Find datasets to predict Boston housing prices",
    ...
    # Taxi (3)
    {"id":"D07","cat":"taxi","query":"Find datasets for predicting taxi trip fare",
    ...
    # Medical (3)
    {"id":"D10","cat":"medical","query":"Find cancer patient data with treatment cost and severity",
    ...
    # MBA (2)
    {"id":"D13","cat":"mba","query":"Find MBA admission data with GPA and GMAT scores",
    ...
    # Insurance (2)
    {"id":"D15","cat":"insurance","query":"Find insurance data to predict medical charges",
    ...
    # IoT (3)
    {"id":"D17","cat":"iot","query":"Find machine sensor data with temperature and vibration",
    ...
    # Energy (2)
    {"id":"D20","cat":"energy","query":"Find energy consumption data by building type",
    ...
    # Animal (2)
    {"id":"D22","cat":"animal","query":"Find cat breed data with weight and body length",
    ...
    # Ecommerce (2)
    {"id":"D24","cat":"ecommerce","query":"Find e-commerce order data with price and freight value",
